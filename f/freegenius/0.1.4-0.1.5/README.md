# Comparing `tmp/freegenius-0.1.4.tar.gz` & `tmp/freegenius-0.1.5.tar.gz`
...
### Comparing `freegenius-0.1.4/PKG-INFO` & `freegenius-0.1.5/PKG-INFO`
...
### Comparing `freegenius-0.1.4/freegenius/gui/chatgui.py` & `freegenius-0.1.5/freegenius/gui/chatgui.py`
...
### Comparing `freegenius-0.1.4/freegenius/plugins/character analysis.py` & `freegenius-0.1.5/freegenius/plugins/character analysis.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/chat.py` & `freegenius-0.1.5/freegenius/plugins/chat.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/contexts.py` & `freegenius-0.1.5/freegenius/plugins/contexts.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/counselling.py` & `freegenius-0.1.5/freegenius/plugins/counselling.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/create ai assistants.py` & `freegenius-0.1.5/freegenius/plugins/create ai assistants.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/create images.py` & `freegenius-0.1.5/freegenius/plugins/create images.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/create maps.py` & `freegenius-0.1.5/freegenius/plugins/create maps.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/create qrcode.py` & `freegenius-0.1.5/freegenius/plugins/create qrcode.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/create statistical graphics.py` & `freegenius-0.1.5/freegenius/plugins/create statistical graphics.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/dates and times.py` & `freegenius-0.1.5/freegenius/plugins/dates and times.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/download youtube or web content.py` & `freegenius-0.1.5/freegenius/plugins/download youtube or web content.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/edit text.py` & `freegenius-0.1.5/freegenius/plugins/edit text.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/execute computing tasks.py` & `freegenius-0.1.5/freegenius/plugins/execute computing tasks.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/execute termux command.py` & `freegenius-0.1.5/freegenius/plugins/execute termux command.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/global finance.py` & `freegenius-0.1.5/freegenius/plugins/global finance.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/improve British English.py` & `freegenius-0.1.5/freegenius/plugins/improve British English.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/input suggestions.py` & `freegenius-0.1.5/freegenius/plugins/input suggestions.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/install python package.py` & `freegenius-0.1.5/freegenius/plugins/install python package.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/integrate google searches.py` & `freegenius-0.1.5/freegenius/plugins/integrate google searches.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/memory.py` & `freegenius-0.1.5/freegenius/plugins/memory.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/modify images.py` & `freegenius-0.1.5/freegenius/plugins/modify images.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/open web browser.py` & `freegenius-0.1.5/freegenius/plugins/open web browser.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/pronounce words.py` & `freegenius-0.1.5/freegenius/plugins/pronounce words.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/remove image background.py` & `freegenius-0.1.5/freegenius/plugins/remove image background.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/search chat records.py` & `freegenius-0.1.5/freegenius/plugins/search chat records.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/search financial data.py` & `freegenius-0.1.5/freegenius/plugins/search financial data.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/search latest news.py` & `freegenius-0.1.5/freegenius/plugins/search latest news.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/search sqlite.py` & `freegenius-0.1.5/freegenius/plugins/search sqlite.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/search weather info.py` & `freegenius-0.1.5/freegenius/plugins/search weather info.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/send email.py` & `freegenius-0.1.5/freegenius/plugins/send email.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/send tweet.py` & `freegenius-0.1.5/freegenius/plugins/send tweet.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/send whatsapp messages.py` & `freegenius-0.1.5/freegenius/plugins/send whatsapp messages.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/plugins/simplified Chinese to traditional Chinese.py` & `freegenius-0.1.5/freegenius/plugins/simplified Chinese to traditional Chinese.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/rag.py` & `freegenius-0.1.5/freegenius/rag.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/requirements.txt` & `freegenius-0.1.5/freegenius/requirements.txt`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/servers.py` & `freegenius-0.1.5/freegenius/servers.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/systemtray.py` & `freegenius-0.1.5/freegenius/systemtray.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/assistant.py` & `freegenius-0.1.5/freegenius/utils/assistant.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/call_chatgpt.py` & `freegenius-0.1.5/freegenius/utils/call_chatgpt.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/call_gemini.py` & `freegenius-0.1.5/freegenius/utils/call_gemini.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/call_groq.py` & `freegenius-0.1.5/freegenius/utils/call_groq.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/call_llamacpp.py` & `freegenius-0.1.5/freegenius/utils/call_llamacpp.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/call_llm.py` & `freegenius-0.1.5/freegenius/utils/call_llm.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/call_ollama.py` & `freegenius-0.1.5/freegenius/utils/call_ollama.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/config_essential.py` & `freegenius-0.1.5/freegenius/utils/config_essential.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/config_tools.py` & `freegenius-0.1.5/freegenius/utils/config_tools.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/download.py` & `freegenius-0.1.5/freegenius/utils/download.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/get_path_prompt.py` & `freegenius-0.1.5/freegenius/utils/get_path_prompt.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/ollama_models.py` & `freegenius-0.1.5/freegenius/utils/ollama_models.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/promptValidator.py` & `freegenius-0.1.5/freegenius/utils/promptValidator.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/prompt_multiline_shared_key_bindings.py` & `freegenius-0.1.5/freegenius/utils/prompt_multiline_shared_key_bindings.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/prompt_shared_key_bindings.py` & `freegenius-0.1.5/freegenius/utils/prompt_shared_key_bindings.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/prompts.py` & `freegenius-0.1.5/freegenius/utils/prompts.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/python_utils.py` & `freegenius-0.1.5/freegenius/utils/python_utils.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/shared_utils.py` & `freegenius-0.1.5/freegenius/utils/shared_utils.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/shortcuts.py` & `freegenius-0.1.5/freegenius/utils/shortcuts.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/single_prompt.py` & `freegenius-0.1.5/freegenius/utils/single_prompt.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/streaming_word_wrapper.py` & `freegenius-0.1.5/freegenius/utils/streaming_word_wrapper.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/sttLanguages.py` & `freegenius-0.1.5/freegenius/utils/sttLanguages.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/terminal_mode_dialogs.py` & `freegenius-0.1.5/freegenius/utils/terminal_mode_dialogs.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/terminal_system_command_prompt.py` & `freegenius-0.1.5/freegenius/utils/terminal_system_command_prompt.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/text_utils.py` & `freegenius-0.1.5/freegenius/utils/text_utils.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/tool_plugins.py` & `freegenius-0.1.5/freegenius/utils/tool_plugins.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/ttsLanguages.py` & `freegenius-0.1.5/freegenius/utils/ttsLanguages.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/tts_utils.py` & `freegenius-0.1.5/freegenius/utils/tts_utils.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius/utils/vlc_utils.py` & `freegenius-0.1.5/freegenius/utils/vlc_utils.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius.egg-info/PKG-INFO` & `freegenius-0.1.5/freegenius.egg-info/PKG-INFO`
...
### Comparing `freegenius-0.1.4/freegenius.egg-info/SOURCES.txt` & `freegenius-0.1.5/freegenius.egg-info/SOURCES.txt`

 * *Files 0% similar despite different names*

```diff
@@ -7,15 +7,14 @@
 freegenius/chatgpt.py
 freegenius/codey.py
 freegenius/commandprompt.py
 freegenius/config.py
 freegenius/eTextEdit.py
 freegenius/geminipro.py
 freegenius/geminiprovision.py
-freegenius/groq.py
 freegenius/groqchat.py
 freegenius/llamacpp.py
 freegenius/main.py
 freegenius/ollamachat.py
 freegenius/package_name.txt
 freegenius/palm2.py
 freegenius/qt.py
```

### Comparing `freegenius-0.1.4/freegenius.egg-info/entry_points.txt` & `freegenius-0.1.5/freegenius.egg-info/entry_points.txt`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/freegenius.egg-info/requires.txt` & `freegenius-0.1.5/freegenius.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.4/setup.py` & `freegenius-0.1.5/setup.py`
