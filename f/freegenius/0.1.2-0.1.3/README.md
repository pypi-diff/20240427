# Comparing `tmp/freegenius-0.1.2.tar.gz` & `tmp/freegenius-0.1.3.tar.gz`
...
### Comparing `freegenius-0.1.2/PKG-INFO` & `freegenius-0.1.3/PKG-INFO`
...
### Comparing `freegenius-0.1.2/freegenius/audio/notification2_mild.mp3` & `freegenius-0.1.3/freegenius/audio/notification2_mild.mp3`
...
### Comparing `freegenius-0.1.2/freegenius/palm2.py` & `freegenius-0.1.3/freegenius/palm2.py`
...
### Comparing `freegenius-0.1.2/freegenius/plugins/create qrcode.py` & `freegenius-0.1.3/freegenius/plugins/create qrcode.py`
...
### Comparing `freegenius-0.1.2/freegenius/plugins/input suggestions.py` & `freegenius-0.1.3/freegenius/plugins/input suggestions.py`
...
### Comparing `freegenius-0.1.2/freegenius/plugins/search financial data.py` & `freegenius-0.1.3/freegenius/plugins/search financial data.py`
...
### Comparing `freegenius-0.1.2/freegenius/utils/assistant.py` & `freegenius-0.1.3/freegenius/utils/assistant.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/call_chatgpt.py` & `freegenius-0.1.3/freegenius/utils/call_chatgpt.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/call_gemini.py` & `freegenius-0.1.3/freegenius/utils/call_gemini.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/call_groq.py` & `freegenius-0.1.3/freegenius/utils/call_groq.py`
...
### Comparing `freegenius-0.1.2/freegenius/utils/call_llamacpp.py` & `freegenius-0.1.3/freegenius/utils/call_llamacpp.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/call_llm.py` & `freegenius-0.1.3/freegenius/utils/call_llm.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/call_ollama.py` & `freegenius-0.1.3/freegenius/utils/call_ollama.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/config_essential.py` & `freegenius-0.1.3/freegenius/utils/config_essential.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/config_tools.py` & `freegenius-0.1.3/freegenius/utils/config_tools.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/download.py` & `freegenius-0.1.3/freegenius/utils/download.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/get_path_prompt.py` & `freegenius-0.1.3/freegenius/utils/get_path_prompt.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/ollama_models.py` & `freegenius-0.1.3/freegenius/utils/ollama_models.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/promptValidator.py` & `freegenius-0.1.3/freegenius/utils/promptValidator.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/prompt_multiline_shared_key_bindings.py` & `freegenius-0.1.3/freegenius/utils/prompt_multiline_shared_key_bindings.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/prompt_shared_key_bindings.py` & `freegenius-0.1.3/freegenius/utils/prompt_shared_key_bindings.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/prompts.py` & `freegenius-0.1.3/freegenius/utils/prompts.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/python_utils.py` & `freegenius-0.1.3/freegenius/utils/python_utils.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/shared_utils.py` & `freegenius-0.1.3/freegenius/utils/shared_utils.py`
...
### Comparing `freegenius-0.1.2/freegenius/utils/shortcuts.py` & `freegenius-0.1.3/freegenius/utils/shortcuts.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/single_prompt.py` & `freegenius-0.1.3/freegenius/utils/single_prompt.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/streaming_word_wrapper.py` & `freegenius-0.1.3/freegenius/utils/streaming_word_wrapper.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/sttLanguages.py` & `freegenius-0.1.3/freegenius/utils/sttLanguages.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/terminal_mode_dialogs.py` & `freegenius-0.1.3/freegenius/utils/terminal_mode_dialogs.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/terminal_system_command_prompt.py` & `freegenius-0.1.3/freegenius/utils/terminal_system_command_prompt.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/text_utils.py` & `freegenius-0.1.3/freegenius/utils/text_utils.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/tool_plugins.py` & `freegenius-0.1.3/freegenius/utils/tool_plugins.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/ttsLanguages.py` & `freegenius-0.1.3/freegenius/utils/ttsLanguages.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/tts_utils.py` & `freegenius-0.1.3/freegenius/utils/tts_utils.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius/utils/vlc_utils.py` & `freegenius-0.1.3/freegenius/utils/vlc_utils.py`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius.egg-info/PKG-INFO` & `freegenius-0.1.3/freegenius.egg-info/PKG-INFO`
...
### Comparing `freegenius-0.1.2/freegenius.egg-info/SOURCES.txt` & `freegenius-0.1.3/freegenius.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/freegenius.egg-info/entry_points.txt` & `freegenius-0.1.3/freegenius.egg-info/entry_points.txt`
...
### Comparing `freegenius-0.1.2/freegenius.egg-info/requires.txt` & `freegenius-0.1.3/freegenius.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `freegenius-0.1.2/setup.py` & `freegenius-0.1.3/setup.py`
