# Comparing `tmp/inducoapi-2.1.4.tar.gz` & `tmp/inducoapi-2.1.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "inducoapi-2.1.4.tar", max compression
+gzip compressed data, was "inducoapi-2.1.5.tar", max compression
```

## Comparing `inducoapi-2.1.4.tar` & `inducoapi-2.1.5.tar`

### file list

```diff
@@ -1,8 +1,8 @@
--rw-r--r--   0        0        0    11357 2023-12-18 13:19:51.005371 inducoapi-2.1.4/LICENSE
--rw-r--r--   0        0        0     6159 2023-12-18 13:19:51.005371 inducoapi-2.1.4/README.md
--rw-r--r--   0        0        0       88 2023-12-18 13:19:51.005371 inducoapi-2.1.4/inducoapi/__init__.py
--rwxr-xr-x   0        0        0     5431 2023-12-18 13:19:51.005371 inducoapi-2.1.4/inducoapi/__main__.py
--rwxr-xr-x   0        0        0     6139 2023-12-18 13:19:51.005371 inducoapi-2.1.4/inducoapi/inducoapi.py
--rw-r--r--   0        0        0      695 2023-12-18 13:19:51.009371 inducoapi-2.1.4/pyproject.toml
--rw-r--r--   0        0        0     7278 1970-01-01 00:00:00.000000 inducoapi-2.1.4/setup.py
--rw-r--r--   0        0        0     7004 1970-01-01 00:00:00.000000 inducoapi-2.1.4/PKG-INFO
...
### Comparing `inducoapi-2.1.4/LICENSE` & `inducoapi-2.1.5/LICENSE`

 * *Files identical despite different names*

### Comparing `inducoapi-2.1.4/README.md` & `inducoapi-2.1.5/README.md`

 * *Files identical despite different names*

### Comparing `inducoapi-2.1.4/inducoapi/__main__.py` & `inducoapi-2.1.5/inducoapi/__main__.py`

 * *Files identical despite different names*

### Comparing `inducoapi-2.1.4/inducoapi/inducoapi.py` & `inducoapi-2.1.5/inducoapi/inducoapi.py`

 * *Files identical despite different names*

### Comparing `inducoapi-2.1.4/pyproject.toml` & `inducoapi-2.1.5/pyproject.toml`
...
### Comparing `inducoapi-2.1.4/setup.py` & `inducoapi-2.1.5/setup.py`
...
### Comparing `inducoapi-2.1.4/PKG-INFO` & `inducoapi-2.1.5/PKG-INFO`
